...
Hotel *buatData(int nomorKamar, char jenisKamar[], int hargaKamar, int lantaiKamar, int statusKamar)
{
    ...
    newNode->lantaiKamar = lantaiKamar;
    newNode->statusKamar = statusKamar;
    newNode->next = NULL;
    return newNode;
}

void tambahData(Hotel **headRef, int nomorKamar, char jenisKamar[], int hargaKamar, int lantaiKamar, int statusKamar)
{
    Hotel *newNode = buatData(nomorKamar, jenisKamar, hargaKamar, lantaiKamar, statusKamar);
    if (*headRef == NULL)
    {
        *headRef = newNode;
    }
...
{
    printf("=================================================================================\n");
    printf("| Nomor Kamar |    Jenis Kamar     | Harga Kamar | Lantai Kamar | Status Kamar |\n");
    printf("=================================================================================\n");
    Hotel *temp = head;
    while (temp != NULL)
    {
        printf("| %11d | %18s | %11d | %11d | %12d |\n", temp->nomorKamar, temp->jenisKamar, temp->hargaKamar, temp->lantaiKamar, temp->statusKamar);
        temp = temp->next;
    }
    printf("==================================================================================\n");
}
...
void ubahData(Hotel **headRef, int nomorKamar, char jenisKamar[], int hargaKamar, int lantaiKamar, int statusKamar)
{
    Hotel *temp = *headRef;
    while (temp != NULL)
    {
...
void simpanFile(Hotel *head)
{
    ...
    while (current != NULL)
    {
        fprintf(file, "%d %s %d %d %d\n", current->nomorKamar, current->jenisKamar, current->hargaKamar, current->lantaiKamar, current->statusKamar);
        current = current->next;
    }
    fclose(file);
    gotoxy(46,18);
...
void bacaFile(Hotel **headRef)
{
    ...
    int nomorKamar, hargaKamar, lantaiKamar, statusKamar;
    char jenisKamar[20];
    while (fscanf(file, "%d %s %d %d %d", &nomorKamar, jenisKamar, &hargaKamar, &lantaiKamar, &statusKamar)!=EOF)
    {
        tambahData(headRef, nomorKamar, jenisKamar, hargaKamar, lantaiKamar, statusKamar);
    }
    fclose(file);
    gotoxy(46,18);
...
void sortingBubble(Hotel *head)
{
    ...
    do
    {
        ...
        {
            if (current->hargaKamar > current->next->hargaKamar)//inisialisasi pertukaran data
            {
                Hotel temp;
                strcpy(temp.jenisKamar, current->jenisKamar);
                temp.nomorKamar = current->nomorKamar;
                temp.hargaKamar = current->hargaKamar;
                temp.lantaiKamar = current->lantaiKamar;
                ...
                current->lantaiKamar = current->next->lantaiKamar;
                ...
                current->next->lantaiKamar = temp.lantaiKamar;
...
{
    Hotel *head = NULL;
    int pilihan, nomorKamar, hargaKamar, lantaiKamar, statusKamar,verified;
    char jenisKamar[20];
    ...
    do
    {
        ...
        case 2:
            ...
            scanf("%d", &hargaKamar);
            printf("Masukan lantai kamar: ");
            scanf("%d", &lantaiKamar);
            printf("Masukkan status kamar (0 untuk kosong, 1 untuk terisi): ");
            scanf("%d", &statusKamar);
            tambahData(&head, nomorKamar, jenisKamar, hargaKamar, lantaiKamar, statusKamar);
            break;
        case 3:
            system("cls");
            ...
            {
                printf("Data ditemukan : | %d | %s | %d | %d | %d |\n", foundData->nomorKamar, foundData->jenisKamar, foundData->hargaKamar, foundData->lantaiKamar, foundData->statusKamar);
                ...
                printf("Masukan lantai kamar baru: ");
                scanf("%d", &foundData->lantaiKamar);
        ...
        case 5:
            ...
            {
                printf("Data ditemukan: | %d | %s | %d | %d | %d |\n", searchData->nomorKamar, searchData->jenisKamar, searchData->hargaKamar, searchData->lantaiKamar, searchData->statusKamar);
            }
            getch();
            break;
        case 6:
